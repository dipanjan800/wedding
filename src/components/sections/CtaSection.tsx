...
export default function CtaSection() {
  return (
    ...
    >
      ...
      {/* Decorative Gold Filigree Grid Borders */}
      <div className="absolute inset-x-12 top-0 h-px bg-gradient-to-r from-transparent via-[#D4AF37]/30 to-transparent" />
      <div className="absolute inset-x-12 bottom-0 h-px bg-gradient-to-r from-transparent via-[#D4AF37]/30 to-transparent" />
      ...
      <div className="mx-auto max-w-5xl px-6 md:px-12 text-center relative z-10 space-y-10">
        ...
        <motion.div
          ...
          className="pt-12 border-t border-white/[0.06] max-w-xs mx-auto"
        >
